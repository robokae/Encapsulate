...
insert into Posts values (1, 6, '11-1-2021', 3, 'nibh venenatis cras sed felis eget velit aliquet sagittis id consectetur purus ut faucibus pulvinar elementum integer enim neque volutpat');
insert into Posts values (2, 10, '11-3-2021', 1, 'dolor sit amet consectetur adipiscing elit pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas integer');
insert into Posts values (3, 9,	'11-4-2021', 5,	'risus ultricies tristique nulla aliquet enim tortor at auctor urna nunc id cursus metus aliquam eleifend mi in nulla posuere');
insert into Posts values (4, 7, '11-6-2021', 9, 'quis risus sed vulputate odio ut enim blandit volutpat maecenas volutpat blandit aliquam etiam erat velit scelerisque in dictum non');
insert into Posts values (5, 6, '11-7-2021', 10, 'sagittis id consectetur purus ut faucibus pulvinar elementum integer enim neque volutpat ac tincidunt vitae semper quis lectus nulla at');
insert into Posts values (6, 3, '11-8-2021', 2, 'vel facilisis volutpat est velit egestas dui id ornare arcu odio ut sem nulla pharetra diam sit amet nisl suscipit');
...
insert into Comments values (1, 7, 5, '11-1-2021', 'blandit turpis cursus in hac habitasse platea dictumst quisque sagittis purus sit amet volutpat consequat mauris nunc congue nisi vitae');
insert into Comments values (2, 2, 10, '11-2-2021', 'facilisis sed odio morbi quis commodo odio aenean sed adipiscing diam donec adipiscing tristique risus nec feugiat in fermentum posuere');
insert into Comments values (3, 9, 2, '11-3-2021', 'felis eget nunc lobortis mattis aliquam faucibus purus in massa tempor nec feugiat nisl pretium fusce id velit ut tortor');
insert into Comments values (4, 9, 3, '11-6-2021', 'eu scelerisque felis imperdiet proin fermentum leo vel orci porta non pulvinar neque laoreet suspendisse interdum consectetur libero id faucibus');
insert into Comments values (5, 8, 10, '11-7-2021', 'nulla aliquet enim tortor at auctor urna nunc id cursus metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices');
insert into Comments values (6, 10, 9, '11-8-2021', 'vestibulum rhoncus est pellentesque elit ullamcorper dignissim cras tincidunt lobortis feugiat vivamus at augue eget arcu dictum varius duis at');
insert into Comments values (7, 5, 10, '11-9-2021', 'rutrum tellus pellentesque eu tincidunt tortor aliquam nulla facilisi cras fermentum odio eu feugiat pretium nibh ipsum consequat nisl vel');
...
insert into CommentReplies values(1, 1, 'ut ornare lectus sit amet est placerat in egestas erat imperdiet sed euismod nisi porta lorem mollis aliquam ut porttitor');
insert into CommentReplies values(2, 9, 'sed id semper risus in hendrerit gravida rutrum quisque non tellus orci ac auctor augue mauris augue neque gravida in');
insert into CommentReplies values(3, 7, 'at urna condimentum mattis pellentesque id nibh tortor id aliquet lectus proin nibh nisl condimentum id venenatis a condimentum vitae');
insert into CommentReplies values(4, 10, 'id aliquet lectus proin nibh nisl condimentum id venenatis a condimentum vitae sapien pellentesque habitant morbi tristique senectus et netus');
insert into CommentReplies values(5, 6, 'tristique et egestas quis ipsum suspendisse ultrices gravida dictum fusce ut placerat orci nulla pellentesque dignissim enim sit amet venenatis');
insert into CommentReplies values(6, 4, 'vestibulum mattis ullamcorper velit sed ullamcorper morbi tincidunt ornare massa eget egestas purus viverra accumsan in nisl nisi scelerisque eu');
insert into CommentReplies values(7, 2, 'et odio pellentesque diam volutpat commodo sed egestas egestas fringilla phasellus faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis');
insert into CommentReplies values(8, 10, 'consequat mauris nunc congue nisi vitae suscipit tellus mauris a diam maecenas sed enim ut sem viverra aliquet eget sit');
insert into CommentReplies values(9, 4, 'diam sit amet nisl suscipit adipiscing bibendum est ultricies integer quis auctor elit sed vulputate mi sit amet mauris commodo');
insert into CommentReplies values(10, 1, 'tortor aliquam nulla facilisi cras fermentum odio eu feugiat pretium nibh ipsum consequat nisl vel pretium lectus quam id leo');
...
-- Get all the posts matching a certain search phrase
    -- Example search phrase: 'from user 10'
